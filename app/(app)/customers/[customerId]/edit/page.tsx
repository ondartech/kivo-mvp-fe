...
export default function EditCustomerRedirectPage() {
  ...
  useEffect(() => {
    if (!isLoading && orgId) router.replace(`/${orgId}/customers/${params.customerId}/edit`);
  ...
  return (
    <div className="space-y-6 max-w-[760px]">
      <PageHeader title="Edit customer" />
      <EmptyState title="No organization" description="Join or create an organization to edit this customer." />
    </div>
  );
}
